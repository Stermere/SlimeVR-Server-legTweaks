...
settings-general-fk_settings-leg_tweak-leg_extension = Dynamic Leg length
settings-general-fk_settings-leg_tweak-leg_extension-description = Slightly increase the length of the legs when they approach full extension.
settings-general-fk_settings-leg_tweak-extend_legs = Extend legs
settings-general-fk_settings-leg_tweak-leg_extension-percentage = Percentage length increase
settings-general-fk_settings-leg_tweak-leg_extension-threshold = Extension threshold
